...
// x402-paid for external agents ($0.005/message); free for the Jahpay app itself
export const POST = withRateLimit(
  withX402(handler, {
    price: X402_PRICES.MEDIUM,
    description: 'Chat with the Jahpay swap agent (live Mento market context)',
