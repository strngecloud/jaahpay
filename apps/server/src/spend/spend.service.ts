...
export class SpendService {
     ...
     */
    async initiateSpend(dto: InitiateSpendDto): Promise<InitiateSpendResponseDto> {
        this.logger.log(
     ...
     */
    async updateSpendId(tempSpendId: string, blockchainSpendId: string): Promise<void> {
        await this.spendRepo.update(
            { spendId: tempSpendId },
            { spendId: blockchainSpendId },
        );
        this.logger.log(`Updated temp spend ${tempSpendId} to ${blockchainSpendId}`);
    }
