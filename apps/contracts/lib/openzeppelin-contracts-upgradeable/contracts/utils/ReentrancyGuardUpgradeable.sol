...
// Restored into this vendored snapshot: the upstream master snapshot vendored
// here removed ReentrancyGuardUpgradeable, which SpendRouter.sol depends on.
 ...
 * as `nonReentrant` may not call one another.
 */
abstract contract ReentrancyGuardUpgradeable is Initializable {
    ...
    /**
     * @dev Returns true if the reentrancy guard is currently set to
     * "entered", which indicates there is a `nonReentrant` function in the
     * call stack.
     */
