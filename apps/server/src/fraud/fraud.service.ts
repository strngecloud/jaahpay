...
export class FraudService {
    ...
    async checkTransaction(params: {
        ...
        const { userAddress, amount, recipientAccountNumber, recipientBankCode, transactionHash } = params;
    ...
    private async calculateRiskScore(params: {
        ...
        const totalScore =
            velocityRisk + duplicateRisk + unusualTimeRisk + newUserRisk + highAmountRisk;
    ...
    async cleanupVelocityRecords(): Promise<void> {
        ...
        this.logger.log('Velocity records cleanup completed (handled by Redis TTL)');
    }
}
