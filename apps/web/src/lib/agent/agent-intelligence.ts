  ...
  switch (intent) {
    case 'greeting':
      return {
        intent,
        message:
          "I'm the Jahpay Swap Agent on Celo. I can fetch live Mento rates, quote swaps, recommend slippage, and guide you through USDC↔USDT swaps. Try: \"What's the rate for 500 USDC?\" or \"Swap 100 USDT to USDC\".",
        suggestedActions: [
          { label: 'Get rate', action: 'rate', payload: { amount: '100', fromToken: 'USDC', toToken: 'USDT' } },
          { label: 'Quote 1000 USDC', action: 'quote', payload: { amount: '1000', fromToken: 'USDC', toToken: 'USDT' } },
        ],
      };
